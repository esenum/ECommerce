...
namespace E_commerce_Site.Areas.Customer.Controllers
{
    [Area("Customer")]
    public class CartController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            ShoppingCartVM = new ShoppingCartVM()
            {
                ...
                ListCart = _db.ShoppingCarts
                            .Where(i => i.ApplicationUserId == claim.Value).Include(i => i.Product)
        ...
        private Payment PaymentProcess(ShoppingCartVM model)
        {
            ...
            options.ApiKey = "sandbox-17BX2tUKOFy8xdqQwG2lj78pIYJ89gye";
            options.SecretKey = "sandbox-vcgUheoHhEOiQXpECNK0zWsU1V0a6fl7";
            ...
            shippingAddress.Description = "Sehit Er Cihan Namli Road, Kekik Street, No:45/10";
            shippingAddress.ZipCode = "34387";
            ...
            billingAddress.Description = "Sehit Er Cihan Namli Road, Kekik Street, No:45/10";
            billingAddress.ZipCode = "34387";
